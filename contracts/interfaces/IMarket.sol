...
interface IMarket {
    ...
    event CancelOrder(address indexed account, uint256 indexed orderId, address token, address currency, uint256 price, uint256 amount, bool bidAsk, uint256 timestamp);
    event TakeOrder(address indexed account, uint256 indexed orderId, address indexed maker, address token, address currency, uint256 price, uint256 amount, uint256 filled, bool bidAsk, uint256 timestamp);
